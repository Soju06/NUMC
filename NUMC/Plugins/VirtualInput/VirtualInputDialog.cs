...
namespace NUMC.Plugins.VirtualInput
{
    public partial class VirtualInputDialog : Dialog
    {
        ...
        private void InitializeForm()
        {
            ...
            Text = Service.GetTitleName(Language.Language.VirtualInputDialog_Title);
        ...
        public void InitializeSetting() {
            ...
            } else KeyboardTypeComboBox.SelectedIndex = 0;
            _initializedSetting = true;
        }

        private void VirtualInput_Load(object sender, EventArgs e) => 
            KeyboardTypeComboBox.Refresh();

        private void VirtualInput_Closing(object sender, FormClosingEventArgs e) => 
            KeyboardHook.KeyDown -= KeyboardHook_KeyDown;
        ...
        private void DeleteVirtualKey() {
            var ary = ScriptTextBox.Text.Replace(" ", "").Split(',');
        ...
        private void KeyboardTypeComboBox_SelectedIndexChanged(object sender, EventArgs e) {
            ...
            if (_initializedSetting) ScriptTextBox.Text = string.Empty;
        }
        ...
        private void KeyTextBox_KeyDown(object sender, KeyEventArgs e) {
            if (VirtualMode) {
                if (e.KeyCode == Keys.Back) DeleteVirtualKey();
        ...
        private bool VirtualMode { 
            get => KeyboardTypeComboBox.SelectedIndex < 2; 
        }
        ...
        private void AddButton_Click(object sender, EventArgs e) {
            ...
            if (ScriptTextBox.Text.Split(',').Length > 25) return;
        ...
        private void BtnOk_Click(object sender, EventArgs e) {
            if (string.IsNullOrWhiteSpace(ScriptTextBox.Text)) {
                ...
                else RuntimeScript.Data = ScriptTextBox.Text;
        ...
        private void RemoveButton_Click(object sender, EventArgs e) {
            if (VirtualMode) DeleteVirtualKey();
        }
    }
}
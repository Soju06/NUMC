...
namespace WindowsInput
{
    ...
    public interface IKeyboardSimulator
    {
        ...
        /// </summary>
        /// <param name="modifierKeyCodes">The list of <see cref="Keys"/>s for the modifier keys.</param>
        /// <param name="keyCodes">The list of <see cref="Keys"/>s for the keys to simulate.</param>
        IKeyboardSimulator ModifiedKeyStroke(IEnumerable<Keys> modifierKeyCodes, IEnumerable<Keys> keyCodes);
        ...
        /// <param name="modifierKeyCodes">The list of <see cref="Keys"/>s for the modifier keys.</param>
        /// <param name="keyCode">The <see cref="Keys"/> for the key.</param>
        IKeyboardSimulator ModifiedKeyStroke(IEnumerable<Keys> modifierKeyCodes, Keys keyCode);
        ...
        /// </summary>
        /// <param name="modifierKey">The <see cref="Keys"/> for the modifier key.</param>
        /// <param name="keyCodes">The list of <see cref="Keys"/>s for the keys to simulate.</param>
        IKeyboardSimulator ModifiedKeyStroke(Keys modifierKey, IEnumerable<Keys> keyCodes);
        ...
        /// </summary>
        /// <param name="modifierKeyCode">The <see cref="Keys"/> for the  modifier key.</param>
        /// <param name="keyCode">The <see cref="Keys"/> for the key.</param>
        IKeyboardSimulator ModifiedKeyStroke(Keys modifierKeyCode, Keys keyCode);

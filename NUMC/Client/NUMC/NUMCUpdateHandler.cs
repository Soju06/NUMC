...
{
    public class NUMCUpdateHandler : Plugin.ReleaseDownloader.ReleaseDownloadHandler
    {
        ...
        public override void CancelButtonClick() => Downloader?.Close();
        ...
        private void Download()
        {
            ...
            for (int i = 0; i < _release.Assets.Count; i++) {
                ...
                if (a == null || a.Name == null || a.ContentType == null || !FileNameCheck(a.Name)
                    || !a.ContentType.Contains("application/x-zip-compressed"))
                    continue;
            ...
            _client.DownloadFileAsync(new Uri(asset.BrowserDownloadUrl), _tempPath);
        }
        ...
        private void DownloadCompleted(object sender, System.ComponentModel.AsyncCompletedEventArgs e)
        {
            ...
            try
            {
                ...
                Process.Start(h, $"-c \"{Application.ExecutablePath}\"");
                Environment.Exit(0);
            }
            catch (Exception ex)
            {

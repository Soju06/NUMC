...
{
    public class BrightScrollBar : Control
    {
        #region Event Region
    ...
    public abstract class BrightScrollBase : Control
    {
        ...
        protected readonly BrightScrollBar _vScrollBar;
        protected readonly BrightScrollBar _hScrollBar;
        ...
        protected BrightScrollBase()
        {
            SetStyle(ControlStyles.Selectable |
                     ControlStyles.UserMouse, true);

            _vScrollBar = new BrightScrollBar { ScrollOrientation = BrightScrollOrientation.Vertical };
            _hScrollBar = new BrightScrollBar { ScrollOrientation = BrightScrollOrientation.Horizontal };

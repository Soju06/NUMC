    ...
    public class LayeredWindowHelper
    {
      ...
      //  private static WinAPI.WndProcDelegate m_CtrlWndProcDelegate_1;
        ...
        public LayeredWindowHelper(Form host)
        {
            ...
            GC.KeepAlive(m_CtrlWndProcDelegate);
          //  GC.KeepAlive(m_CtrlWndProcDelegate_1);
        ...
        private void RefreshCtrl()
        {
            ...
            int width = host.ClientRectangle.Width+14;//BORDER is 14
                ...
                foreach (Control ctrl in host.Controls)
                {
                    ...
                    if (ctrl is Label)
                    {
                        ...
                        else
                        {
                            ...
                            graphic.DrawString((string)ctrl.Text, (Font)ctrl.Font, drawBrush, realpos);
                        }
                    ...
                    else if (ctrl is CheckBox)
                    {
                        ...
                        {
                            SolidBrush drawBrush = new SolidBrush(ctrl.ForeColor);
                            graphic.DrawString((string)ctrl.Text, (Font)ctrl.Font, drawBrush, realpos.X + 18, realpos.Y);
                        }
                        #endregion
                    }
                    else if (ctrl is RadioButton)
                    {
                        ...
                        //CLEAN EDGES
                        LockBitmap lockOrrig = new LockBitmap(bmp);
                        lockOrrig.LockBits();

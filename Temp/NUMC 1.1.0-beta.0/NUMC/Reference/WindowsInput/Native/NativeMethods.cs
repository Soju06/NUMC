...
namespace WindowsInput.Native
{
    ...
    internal static class NativeMethods
    {
        ...
        /// </summary>
        /// <param name="Keys">Specifies one of 256 possible virtual-key codes. For more information, see Virtual Key Codes. Windows NT/2000/XP: You can use left- and right-distinguishing constants to specify certain keys. See the Remarks section for further information.</param>
        /// <returns>
        ...
        public static extern Int16 GetAsyncKeyState(UInt16 Keys);
        ...
        /// If a non-English keyboard layout is used, virtual keys with values in the range ASCII A through Z and 0 through 9 are used to specify most of the character keys. For example, for the German keyboard layout, the virtual key of value ASCII O (0x4F) refers to the "o" key, whereas VK_Oem1 refers to the "o with umlaut" key.
        /// </param>
        /// <returns>
        ...
        /// </remarks>
        [DllImport("user32.dll", SetLastError = true)]
        public static extern Int16 GetKeyState(UInt16 Keys);
